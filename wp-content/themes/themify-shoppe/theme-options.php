...
class Themify {
	...
	elseif (is_single() && !is_singular('product')) {
		...
		if ( is_singular( 'portfolio' ) ) {
			remove_action( 'template_redirect', 'themify_cpt_set_post_options', 100 );
			$this->layout = themify_get_both('layout', 'setting-custom_post_portfolio_single', 'sidebar1');
		} else {
