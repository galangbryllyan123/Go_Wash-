...
function themify_theme_fixed_header():string {
	...
	if ( $is === null ){
		$is = '';
		if ( ! in_array( themify_theme_get_header_design(), array( 'none', 'header-bottom', 'header-left-pane', 'header-right-pane', 'header-minbar-left', 'header-minbar-right' ),true ) && themify_get( 'setting-revealing_header', '', true ) !== 'on' ) {
