...
function themify_default_page_layout($data = array()) {
     ...
     */
    $output .= '<p>
					<span class="label">' . __('Title in All Pages', 'themify') . '</span>
					<select name="setting-hide_page_title">' .
	    themify_options_module($show_hide_options, 'setting-hide_page_title') . '
					</select>
				</p>';
    ...
    $output .= '<p>
	    ...
	    themify_options_module($show_hide_options, 'setting-hide_page_image') . '
					</select>
				</p>';
...
function themify_theme_query_product_meta_box() {
	...
	array(
	    ...
	    'type' => 'dropdown',
	    'meta' => array(
		array('value' => 'no', 'name' => __('Show', 'themify'), 'selected' => true),
		array('value' => 'yes', 'name' => __('Hide', 'themify')),
	    )
	),
	// Hide Title
	array(
	    ...
	    'title' => __('Product Title', 'themify'),
	    'description' => '',
	    'type' => 'dropdown',
	    'meta' => array(
		array('value' => 'default', 'name' => '', 'selected' => true),
	...
	array(
	    ...
	    'title' => __('Product Price', 'themify'),
	    'description' => '',
	    'type' => 'dropdown',
	    'meta' => array(
		array('value' => 'default', 'name' => '', 'selected' => true),
	...
	array(
	    ...
	    'title' => __('Product Share', 'themify'),
	    'description' => '',
	    'type' => 'dropdown',
	    'meta' => array(
		array('value' => 'default', 'name' => '', 'selected' => true),
