...
<div class="wrap">
	...
	<table class="tf_status_table widefat" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				<td><?php esc_html_e( 'WordPress Version', 'themify' ); ?>:</td>
				<td>
					<?php
					global $wp_version;
					echo $wp_version;
			...
			<tr>
				<td><?php esc_html_e( 'Storage engine', 'themify' ); ?>:</td>
				<td>
				    <table>
					...
					<tr>
					    <td><?php echo $t?></td>
					    <td>
					    <?php $engine=$wpdb->get_row( $wpdb->prepare( "SHOW TABLE STATUS WHERE Name = '%s'", $t ),ARRAY_A);
						echo $engine['Engine'];
