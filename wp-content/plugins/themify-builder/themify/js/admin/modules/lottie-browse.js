    ...
    TF_LottieBrowse={
        ...
        async render(){
            if(!this.el){
                ...
                if(!root){
                    ...
                    prms.push(Themify.loadJs(Themify.url+'js/admin/notification',!!window.TF_Notification));
                }else{
                    root.style.display='none';
        ...
        renderItems(catId,search,page) {
            ...
            for (let i = 0; i < items.length; ++i) {
                ...
                if(selectedBg!==und){
                    lottie.className+=' '+this.getBg(selectedBg);
                }
                ...
                item.append(lottie,bgWrap, title);
                fr.appendChild(item);
