...
class TB_Tab_Module extends Themify_Builder_Component_Module {
	...
	$mobile_tab = array(
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_color(' .tab-nav-current-active', 'b_c_m_t', 'bg_c', 'background-color')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_color(' .tab-nav-current-active', 'b_c_m_t', 'bg_c', 'background-color', 'h')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_font_family(' .tab-nav-current-active', 'f_f_m_t'),
			    self::get_color(' .tab-nav-current-active', 'f_c_m_t'),
			    self::get_font_size(' .tab-nav-current-active', 'f_s_m_t'),
			    self::get_font_style(' .tab-nav-current-active', 'f_fs_m_t', 'f_fw_m_t'),
			    self::get_line_height(' .tab-nav-current-active', 'l_h_m_t'),
				self::get_text_shadow(' .tab-nav-current-active', 't_sh_m_t'),
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_font_family(' .tab-nav-current-active', 'f_f_m_t', 'h'),
			    self::get_color(' .tab-nav-current-active:hover', 'f_c_m_t_h'),
			    self::get_font_size(' .tab-nav-current-active', 'f_s_m_t', '', 'h'),
				self::get_font_style(' .tab-nav-current-active', 'f_fs_m_t', 'f_fw_m_t', 'h'),
				self::get_text_shadow(' .tab-nav-current-active', 't_sh_m_t','h'),
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_padding(' .tab-nav-current-active', 'p_m_t')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_padding(' .tab-nav-current-active', 'p_m_t', 'h')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_border(' .tab-nav-current-active', 'b_m_t')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_border(' .tab-nav-current-active', 'b_m_t', 'h')
			)
		    )
		))
	    )),
		...
		self::get_expand('r_c', array(
			self::get_tab(array(
				'n' => array(
					'options' => array(
						self::get_border_radius(' .tab-nav-current-active', 'r_c_m_t')
					)
				),
				'h' => array(
					'options' => array(
						self::get_border_radius(' .tab-nav-current-active', 'r_c_m_t', 'h')
					)
				)
			))
		)),
		...
		self::get_expand('sh', array(
			self::get_tab(array(
				'n' => array(
					'options' => array(
						self::get_box_shadow(' .tab-nav-current-active', 'b_sh_m_t')
					)
				),
				'h' => array(
					'options' => array(
						self::get_box_shadow(' .tab-nav-current-active', 'b_sh_m_t', 'h')
					)
				)
			))
		))
