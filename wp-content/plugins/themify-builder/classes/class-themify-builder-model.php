	...
	public static function get_paths() {
		...
		$arr= array(
			...
			'predesigned' => array(
				...
				'url'=>'https://themify.org/public-api/builder-layouts/index.json',
				// URL to file containing Builder data for layout {SLUG}
				'single' => 'https://themify.org/public-api/builder-layouts/{SLUG}.json',
			),
			// Pre-designed rows
			'rows_index' => 'https://themify.org/public-api/predesigned-rows/index.json',
			// row template
			'row_template' => 'https://themify.org/public-api/predesigned-rows/{SLUG}.json'
		);
