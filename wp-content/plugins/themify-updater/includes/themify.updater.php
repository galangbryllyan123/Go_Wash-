        ...
        */
        ...
        public function update_notices() {
            ...
            foreach ( $updates as $update ) {
                ...
                $notification = sprintf(
                    ...
                    esc_url('https://themify.org/changelogs/' . $update->name . '.txt'),
                    esc_url('https://themify.org/changelogs/' . $update->name . '.txt')
                );
        ...
        public function plugin_update_row( $file, $plugin_data ) {
            ...
            if ( is_network_admin() || ! is_multisite() ) {
                ...
                $details_url = esc_url( 'https://themify.org/changelogs/'. dirname($file). '.txt' );
        ...
        public function theme_update_row( $theme_key, $theme ) {
            ...
            $details_url = esc_url ('https://themify.org/changelogs/'. dirname($theme_key). '.txt' );
        ...
        function admin_widget() {
                ...
                if ( strpos( $update->nicename, $current_theme_name ) !== false ) {
                    ...
                    <li class="themify-update-theme">
                        ...
                        <div class="themify-theme-meta">
                            ...
                            <a href="<?php echo 'https://themify.org/changelogs/' . get_template(); ?>.txt" target="_blank"><?php _e( 'View changelogs', 'themify-updater' ); ?></a>
                        </div>
                    </li>
                    <?php
            ...
            foreach ( $updates as $key => $update ) {
                ...
                <li class="themify-update-plugins">
                    ...
                    <a href="<?php echo admin_url( 'index.php?page=themify-license' ); ?>" class="themify-update-button"><?php _e( 'Update Now', 'themify-updater' ) ?></a>
                    <a href="<?php echo 'https://themify.org/changelogs/' . $update->slug; ?>.txt" target="_blank"><?php _e( 'View changelogs', 'themify-updater' ); ?></a>
                </li>
                <?php
            }
            echo '</ul>';
