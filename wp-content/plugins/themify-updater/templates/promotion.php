        ...
        <li class="theme-post">
            ...
            <div class="theme-info">
                <div class="theme-title">
                    ...
                    <a class="tag-button lightbox" target="_blank" href="https://themify.org/{{{e.slug}}}"><?php _e( 'demo', 'themify-updater' ); ?></a>
                </div>
                <!-- /theme-title -->
...
<ol class="grid3 theme-list tf_clearfix">
    <# var extra = data.extra, demolink = 'https://themify.org/', themify_promotion = window.themify_promotion;
    jQuery.each( data, function( i, e ) {
		if (e.category === 'promo-builder-addons') {
			...
			switch (e.slug) {
				...
				case 'post-type-builder': e.demolink = demolink + 'ptb'; break;
				case 'themify-icons': e.demolink = e.url; break;
				case 'builder': e.demolink = e.url; break;
				case 'conditional-menus': e.demolink = e.url; break;
				case 'builder-pro': e.demolink = demolink + 'pro-master'; break;
				case 'event-post': e.demolink = demolink + 'events-post'; break;
			}
		} else {
			e.demolink =  demolink + 'ptb-addon-' + e.slug;
			switch (e.slug) {
				case 'relation': e.demolink = demolink + 'ptb'; break;
				case 'map-view': e.demolink = demolink + 'ptb'; break;
				case 'search': e.demolink = demolink + 'ptb'; break;
				case 'submissions': e.demolink = demolink + 'ptb'; break;
				case 'extra-fields': e.demolink = demolink + 'ptb'; break;
			}
		}
	#>
	...
	jQuery(function($) {
		...
		$(document).on('themify_update_promo', function () {
			...
			if (!promo_data) {
				...
				$.getJSON( 'https://themify.org/public-api/featured-'+ type +'s/index.json' )
				.done(function( data ){
