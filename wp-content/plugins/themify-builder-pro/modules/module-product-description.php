...
class TB_Product_Description_Module extends Themify_Builder_Component_Module {
	...
	public function __construct() {//backward
		if (method_exists('Themify_Builder_Model', 'add_module')) {
			parent::__construct('product-description');
		} else {//backward
...
if (!method_exists( 'Themify_Builder_Component_Module', 'get_module_class' ) && TB_Product_Description_Module::is_available()) {
	if (method_exists('Themify_Builder_Model', 'add_module')) {
		new TB_Product_Description_Module();
	} else {
