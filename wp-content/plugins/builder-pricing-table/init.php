...
class Builder_Pricing_Table {
    ...
    public static function i18n() {
        load_plugin_textdomain( 'builder-pricing-table', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
    }

    public static function  register_module() {
        $dir = trailingslashit(plugin_dir_path(__FILE__));
        if(method_exists('Themify_Builder_Model', 'add_module')){
            Themify_Builder_Model::add_module($dir . 'modules/module-pricing-table.php' );
        }
        else{
